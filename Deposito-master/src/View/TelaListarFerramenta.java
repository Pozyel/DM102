 ...
 * @author antun
 */
public class TelaListarFerramenta extends javax.swing.JFrame {

    DefaultListModel model = new DefaultListModel();

    public TelaListarFerramenta() {
        initComponents();
        this.setLocationRelativeTo(null);
        FerramentaDAO ferramentadao = new FerramentaDAO();
        ArrayList<Ferramenta> listaDeFerramentas = new ArrayList<>();
        listaDeFerramentas = ferramentadao.buscarFerramentaSemFiltro();
        if (listaDeFerramentas.isEmpty()) {
            model.addElement(" SEM DADOS CADASTRADOS ");
            ListaFuncionarios.setModel(model);
        } else {
            for (int i = 0; i < listaDeFerramentas.size(); i++) {
                model.addElement("NOME: " + listaDeFerramentas.get(i).getNome() +
                        ", NUMERO DE SERIE: " + listaDeFerramentas.get(i).getNumero_Serie() + 
                        ", QTD DISPONIVEL: " +listaDeFerramentas.get(i).getQuantidade());
                ListaFuncionarios.setModel(model);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lista de Ferramentas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarFerramenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListarFerramenta().setVisible(true);
            }
        });
    }
