...
public class TelaDeletarFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        EntradaTextoRegistroParaDeletar.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro Para Deletar"));
        ...
        CPFParaDeletar.setBorder(javax.swing.BorderFactory.createTitledBorder("CPF"));
    ...
    private void BotaoCompletarDadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCompletarDadosActionPerformed
        ...
        for(int i=0; i<listaDeFuncionarios.size(); i++) {
            if(listaDeFuncionarios.get(i).getRegistro() == (Integer.parseInt(EntradaTextoRegistroParaDeletar.getText()))) {
                NomeParaDeletar.setText(listaDeFuncionarios.get(i).getNome());
                CPFParaDeletar.setText(listaDeFuncionarios.get(i).getCPF());
            } else {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        FuncionarioDAO funcionariodao = new FuncionarioDAO();
        funcionariodao.deletarFuncionario(Integer.parseInt(EntradaTextoRegistroParaDeletar.getText()));
