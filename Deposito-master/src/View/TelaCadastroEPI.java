 ...
 * @author antun
 */
public class TelaCadastroEPI extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroEPI
     */
    public TelaCadastroEPI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        EntradaTextoNomeEPI = new javax.swing.JTextField();
        EntradaTextoNumeroSerieEPI = new javax.swing.JTextField();
        ...
        EntradaTextoNomeEPI.setBorder(javax.swing.BorderFactory.createTitledBorder("Nome EPI"));

        EntradaTextoNumeroSerieEPI.setBorder(javax.swing.BorderFactory.createTitledBorder("Numero de Serie do EPI"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(EntradaTextoNomeEPI)
                    .addComponent(EntradaTextoNumeroSerieEPI, javax.swing.GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(EntradaTextoNomeEPI, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(EntradaTextoNumeroSerieEPI, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(85, 85, 85)
    ...
    private void BotaoCancelarCadastroEPIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCancelarCadastroEPIActionPerformed
        EntradaTextoNomeEPI.setText("");
        EntradaTextoNumeroSerieEPI.setText("");
    ...
    private void BotaoCadastroEPIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCadastroEPIActionPerformed
        EPI epi = new EPI(
                Integer.parseInt(EntradaTextoNumeroSerieEPI.getText()),
                EntradaTextoNomeEPI.getText());
        
        EPIDAO epidao = new EPIDAO();
        if(!epidao.buscarEPISemFiltro().contains(Integer.parseInt(EntradaTextoNumeroSerieEPI.getText()))) {
            epidao.inserirEPI(epi);
            System.out.println("Cadastrado");
        } else {
            System.out.println("EPI ja cadastrado");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroEPI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroEPI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField EntradaTextoNomeEPI;
    private javax.swing.JTextField EntradaTextoNumeroSerieEPI;
