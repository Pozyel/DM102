 ...
 * @author antun
 */
public class TelaAtualizarFerramenta extends javax.swing.JFrame {

    /**
     * Creates new form TelaAtualizarFerramenta
     */
    public TelaAtualizarFerramenta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        EntradaTextoNumeroSerieParaAtualizar = new javax.swing.JTextField();
        EntradaTextoNomeFerramentaAtualizado = new javax.swing.JTextField();
        EntradaTextoQuantidadeFerramentaAtualizado = new javax.swing.JTextField();
        ...
        EntradaTextoNumeroSerieParaAtualizar.setBorder(javax.swing.BorderFactory.createTitledBorder("Numero de Serie"));
        EntradaTextoNumeroSerieParaAtualizar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EntradaTextoNumeroSerieParaAtualizarActionPerformed(evt);
            }
        });

        EntradaTextoNomeFerramentaAtualizado.setBorder(javax.swing.BorderFactory.createTitledBorder("Nome"));

        EntradaTextoQuantidadeFerramentaAtualizado.setBorder(javax.swing.BorderFactory.createTitledBorder("Quantidade"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(EntradaTextoNumeroSerieParaAtualizar)
                    .addComponent(EntradaTextoNomeFerramentaAtualizado)
                    .addComponent(EntradaTextoQuantidadeFerramentaAtualizado)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(24, 24, 24)
                .addComponent(EntradaTextoNumeroSerieParaAtualizar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(EntradaTextoNomeFerramentaAtualizado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(EntradaTextoQuantidadeFerramentaAtualizado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void EntradaTextoNumeroSerieParaAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EntradaTextoNumeroSerieParaAtualizarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_EntradaTextoNumeroSerieParaAtualizarActionPerformed
    ...
    private void BotaoCancelarCadastroFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCancelarCadastroFuncionarioActionPerformed
        EntradaTextoNumeroSerieParaAtualizar.setText("");
        EntradaTextoNomeFerramentaAtualizado.setText("");
        EntradaTextoQuantidadeFerramentaAtualizado.setText("");
    ...
    private void BotaoCadastrarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCadastrarFuncionarioActionPerformed
        ...
        ferramentadao.atualizarDadosFerramenta(
                EntradaTextoNomeFerramentaAtualizado.getText(),
                Integer.parseInt(EntradaTextoQuantidadeFerramentaAtualizado.getText()),
                Integer.parseInt(EntradaTextoNumeroSerieParaAtualizar.getText()));
    ...
    private void BotaoCompletarDadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCompletarDadosActionPerformed
        ...
        for(int i=0; i<listaDeFerramenta.size(); i++) {
            if(listaDeFerramenta.get(i).getNumero_Serie()== (Integer.parseInt(EntradaTextoNumeroSerieParaAtualizar.getText()))) {
                EntradaTextoNomeFerramentaAtualizado.setText(listaDeFerramenta.get(i).getNome());
                EntradaTextoQuantidadeFerramentaAtualizado.setText(String.valueOf(listaDeFerramenta.get(i).getQuantidade()));
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAtualizarFerramenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAtualizarFerramenta().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField EntradaTextoNomeFerramentaAtualizado;
    private javax.swing.JTextField EntradaTextoNumeroSerieParaAtualizar;
    private javax.swing.JTextField EntradaTextoQuantidadeFerramentaAtualizado;
