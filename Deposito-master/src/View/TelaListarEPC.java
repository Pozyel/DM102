 ...
 * @author antun
 */
public class TelaListarEPC extends javax.swing.JFrame {

    DefaultListModel model = new DefaultListModel();

    public TelaListarEPC() {
        initComponents();
        ...
        if (listaDeEPC.isEmpty()) {
            model.addElement(" SEM DADOS CADASTRADOS ");
            ListaFuncionarios.setModel(model);
        } else {
            for (int i = 0; i < listaDeEPC.size(); i++) {
                model.addElement("NOME: " + listaDeEPC.get(i).getNome() + ", NUMERO DE SERIE: " + listaDeEPC.get(i).getIdEPC());
                ListaFuncionarios.setModel(model);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lista de EPC's");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListarEPC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListarEPC().setVisible(true);
            }
        });
    }
